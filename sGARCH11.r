...
garch11_AGO <- ugarchfit(g1,data = e_AGO)

#Extract the VOLATILITIES 
vol_AGO <- ts(garch11_AGO@fit$sigma^2,end=c(2020,07),frequency = 12)
...
#Extract
BDI_ex <- filter(ex, iso3 == "BDI") 

#Re-order 
BDI_ex_ord <- BDI_ex[order(BDI_ex$year), ]

#Make a time series of the ordered series
E_BDI <- ts(BDI_ex_ord[,4],start = c(2002,01), end=c(2020,07),frequency = 12)


#Plot log returns
e_BDI = diff(log(E_BDI))
...
garch11_BDI <- ugarchfit(g1,data = e_BDI)

#Extract the VOLATILITIES 
vol_BDI <- ts(garch11_BDI@fit$sigma^2,end=c(2020,07),frequency = 12)
...
#Extract
BEN_ex <- filter(ex, iso3 == "BEN") 

#Re-order 
BEN_ex_ord <- BEN_ex[order(BEN_ex$year), ]

#Make a time series of the ordered series
E_BEN <- ts(BEN_ex_ord[,4],start = c(2002,01), end=c(2020,07),frequency = 12)


#Plot log returns
e_BEN = diff(log(E_BEN))
...
garch11_BEN <- ugarchfit(g1,data = e_BEN)

#Extract the VOLATILITIES 
vol_BEN <- ts(garch11_BEN@fit$sigma^2,end=c(2020,07),frequency = 12)
...
#Extract
BWA_ex <- filter(ex, iso3 == "BWA") 

#Re-order 
BWA_ex_ord <- BWA_ex[order(BWA_ex$year), ]

#Make a time series of the ordered series
E_BWA <- ts(BWA_ex_ord[,4],start = c(2002,01), end=c(2020,07),frequency = 12)


#Plot log returns
e_BWA = diff(log(E_BWA))
...
garch11_BWA <- ugarchfit(g1,data = e_BWA)

#Extract the VOLATILITIES 
vol_BWA <- ts(garch11_BWA@fit$sigma^2,end=c(2020,07),frequency = 12)
...
#Extract
CAF_ex <- filter(ex, iso3 == "CAF") 

#Re-order 
CAF_ex_ord <- CAF_ex[order(CAF_ex$year), ]

#Make a time series of the ordered series
E_CAF <- ts(CAF_ex_ord[,4],start = c(2002,01), end=c(2020,07),frequency = 12)


#Plot log returns
e_CAF = diff(log(E_CAF))
...
garch11_CAF <- ugarchfit(g1,data = e_CAF)

#Extract the VOLATILITIES 
vol_CAF <- ts(garch11_CAF@fit$sigma^2,end=c(2020,07),frequency = 12)
...
#Extract
CIV_ex <- filter(ex, iso3 == "CIV") 

#Re-order 
CIV_ex_ord <- CIV_ex[order(CIV_ex$year), ]

#Make a time series of the ordered series
E_CIV <- ts(CIV_ex_ord[,4],start = c(2002,01), end=c(2020,07),frequency = 12)


#Plot log returns
e_CIV = diff(log(E_CIV))
...
garch11_CIV <- ugarchfit(g1,data = e_CIV)

#Extract the VOLATILITIES 
vol_CIV <- ts(garch11_CIV@fit$sigma^2,end=c(2020,07),frequency = 12)
...
#Extract
CMR_ex <- filter(ex, iso3 == "CMR") 

#Re-order 
CMR_ex_ord <- CMR_ex[order(CMR_ex$year), ]

#Make a time series of the ordered series
E_CMR <- ts(CMR_ex_ord[,4],start = c(2002,01), end=c(2020,07),frequency = 12)


#Plot log returns
e_CMR = diff(log(E_CMR))
...
garch11_CMR <- ugarchfit(g1,data = e_CMR)

#Extract the VOLATILITIES 
vol_CMR <- ts(garch11_CMR@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_COG <- ugarchfit(g1,data = e_COG)

#Extract the VOLATILITIES 
vol_COG <- ts(garch11_COG@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_CPV <- ugarchfit(g1,data = e_CPV)

#Extract the VOLATILITIES 
vol_CPV <- ts(garch11_CPV@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_GAB <- ugarchfit(g1,data = e_GAB)

#Extract the VOLATILITIES 
vol_GAB <- ts(garch11_GAB@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_GHA <- ugarchfit(g1,data = e_GHA)

#Extract the VOLATILITIES 
vol_GHA <- ts(garch11_GHA@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_GIN <- ugarchfit(g1,data = e_GIN)

#Extract the VOLATILITIES 
vol_GIN <- ts(garch11_GIN@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_GMB <- ugarchfit(g1,data = e_GMB)

#Extract the VOLATILITIES 
vol_GMB <- ts(garch11_GMB@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_GNB <- ugarchfit(g1,data = e_GNB)

#Extract the VOLATILITIES 
vol_GNB <- ts(garch11_GNB@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_KEN <- ugarchfit(g1,data = e_KEN)

#Extract the VOLATILITIES 
vol_KEN <- ts(garch11_KEN@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_MDG <- ugarchfit(g1,data = e_MDG)

#Extract the VOLATILITIES 
vol_MDG <- ts(garch11_MDG@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_MLI <- ugarchfit(g1,data = e_MLI)

#Extract the VOLATILITIES 
vol_MLI <- ts(garch11_MLI@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_MOZ <- ugarchfit(g1,data = e_MOZ)

#Extract the VOLATILITIES 
vol_MOZ <- ts(garch11_MOZ@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_MRT <- ugarchfit(g1,data = e_MRT)

#Extract the VOLATILITIES 
vol_MRT <- ts(garch11_MRT@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_MUS <- ugarchfit(g1,data = e_MUS)

#Extract the VOLATILITIES 
vol_MUS <- ts(garch11_MUS@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_NAM <- ugarchfit(g1,data = e_NAM)

#Extract the VOLATILITIES 
vol_NAM <- ts(garch11_NAM@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_NER <- ugarchfit(g1,data = e_NER)

#Extract the VOLATILITIES 
vol_NER <- ts(garch11_NER@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_NGA <- ugarchfit(g1,data = e_NGA)

#Extract the VOLATILITIES 
vol_NGA <- ts(garch11_NGA@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_RWA <- ugarchfit(g1,data = e_RWA)

#Extract the VOLATILITIES 
vol_RWA <- ts(garch11_RWA@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_SDN <- ugarchfit(g1,data = e_SDN)

#Extract the VOLATILITIES 
vol_SDN <- ts(garch11_SDN@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_SEN <- ugarchfit(g1,data = e_SEN)

#Extract the VOLATILITIES 
vol_SEN <- ts(garch11_SEN@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_SLE <- ugarchfit(g1,data = e_SLE)

#Extract the VOLATILITIES 
vol_SLE <- ts(garch11_SLE@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_SWZ <- ugarchfit(g1,data = e_SWZ)

#Extract the VOLATILITIES 
vol_SWZ <- ts(garch11_SWZ@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_SYC <- ugarchfit(g1,data = e_SYC)

#Extract the VOLATILITIES 
vol_SYC <- ts(garch11_SYC@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_TCD <- ugarchfit(g1,data = e_TCD)

#Extract the VOLATILITIES 
vol_TCD <- ts(garch11_TCD@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_TGO <- ugarchfit(g1,data = e_TGO)

#Extract the VOLATILITIES 
vol_TGO <- ts(garch11_TGO@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_TZA <- ugarchfit(g1,data = e_TZA)

#Extract the VOLATILITIES 
vol_TZA <- ts(garch11_TZA@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_UGA <- ugarchfit(g1,data = e_UGA)

#Extract the VOLATILITIES 
vol_UGA <- ts(garch11_UGA@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_ZAF <- ugarchfit(g1,data = e_ZAF)

#Extract the VOLATILITIES 
vol_ZAF <- ts(garch11_ZAF@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_ZMB <- ugarchfit(g1,data = e_ZMB)

#Extract the VOLATILITIES 
vol_ZMB <- ts(garch11_ZMB@fit$sigma^2,end=c(2020,07),frequency = 12)
...
garch11_ZWE <- ugarchfit(g1,data = e_ZWE)

#Extract the VOLATILITIES 
vol_ZWE <- ts(garch11_ZWE@fit$sigma^2,end=c(2020,07),frequency = 12)
